...
from tasks.views import manager_dashboard, employee_dashboard, test, create_task,view_task,update_task, delete_task, dashboard,task_details,MyView,GreetingView,MorningGreetingView,CreateTask,ViewProject,TakDetails,UpdateTask
urlpatterns = [
